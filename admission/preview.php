<?php require_once("config1.php");$reg_no=$_GET['id'];?>
...
<head>
	...
	<title>Registration form 2025</title>
  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         <div class="row">
          <div class="col-2">
          <img src="../logo.png" alt="Logo" width="160" height="60" class="d-inline-block me-2">
          </div>
           <div class="col">
              <div class="main-heading">MY College of Arts, Science & Commerce (Affiliated to University of Mumbai)</div>
     <p class="sub-heading"> Ministry of Corporate Affairs (Govt. of India ) Govt. CIN. No. TS75200CP2921NPL TAN. TCPP90708E</p>
      <div class="address">MY Collage, Business Building Ring Road, Near Google Mall, Zone-II, Highway Titwala, Kalyan, MH, 42105
</div>
         <p class="email"> Email: harshgupt3034@gmail.com , Website: www.My Collage.com</p>
          </div>
          <div class="col-sm-12">
            <hr class="hrcls"> 
          </div>
